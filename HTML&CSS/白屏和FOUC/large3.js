...
//            m.apply(g, v)
//        }
//        if (!w.call(t, o) && !w.call(q, o))throw Error("No " + o);
//        return t[o]
//    }
//
//    function f(o) {
...
//                    E = true
//                } else if (F ===
//                    "module")y = P[M] = d.module(o); else if (w.call(t, F) || w.call(B, F) || w.call(q, F))P[M] = j(F); else if (H.p) {
...
//});
//J.$package(function (g) {
//    var a = document, b = g.type, c = /^[\w-]+$/, e = /^#([\w-]*)$/, j = /^\.([\w-]+)$/, f = "classList"in document.documentElement, n = ["o", "ms", "moz", "webkit"], m = document.createElement("div"), r = {
//        $: function (k, d) {
//            var t;
//            d = d || a;
...
//});
//J.$package(function (g) {
//    var a = window, b = a.document, c = a.navigator, e = g.dom, j = {
//        fixed: function () {
...
//                        target: v.target,
//                        type: "ortchange",
//                        orientation: D > window.innerHeight ? "landscape" : "portrait"
//                    });
//                    C = D
//                }
//            };
...
//            g.support.fixed ? a.setStyle(f, {
//                position: "fixed",
//                top: n.top + "px", left: n.left + "px", bottom: n.bottom + "px", right: n.right + "px"
//            }) : b.on(window, "scrollend", function () {
...
//});
//J.$package(function (g) {
//    var a = g.dom, b = g.event, c = g.type, e = a.isSupprot3d(), j = g.Class({
//        init: function (f) {
...
//            for (var u = "webkitT,MozT,msT,OT,t".split(","), s, A = 0, K = u.length; A < K; A++) {
//                s = u[A] + "ransform";
...
//                    K = c.abs(u.touches[0].pageX - u.touches[1].pageX);
//                    A = c.abs(u.touches[0].pageY - u.touches[1].pageY);
//                    this.touchesDistStart = c.sqrt(K * K + A * A);
...
//                        A = A[5] * 1
//                    } else {
//                        K = getComputedStyle(this.scroller, null).left.replace(/[^0-9-]/g, "") * 1;
//                        A = getComputedStyle(this.scroller, null).top.replace(/[^0-9-]/g, "") * 1
//                    }
//                    if (K != this.x || A != this.y) {
...
//        },
//        _move: function (u) {
//            var s = C ? u.touches[0] : u, A = s.pageX - this.pointX, K = s.pageY - this.pointY, L = this.x + A, Q = this.y + K, R = u.timeStamp || Date.now();
...
//                if (Q > this.minScrollY || Q < this.maxScrollY)Q = this.options.bounce ? this.y + K / 2 : Q >= this.minScrollY || this.maxScrollY >= 0 ? this.minScrollY : this.maxScrollY;
//                this.distX += A;
//                this.distY += K;
...
//                var s = this, A = C ? u.changedTouches[0] : u, K, L, Q = {dist: 0, time: 0}, R = {
//                    dist: 0,
//                    time: 0
//                }, X = (u.timeStamp || Date.now()) - s.startTime, x = s.x, I = s.y;
//                s._unbind(p);
//                s._unbind(y);
//                s._unbind(F);
...
//                            R = I ? s._momentum(I - s.startY, X, -s.y, s.maxScrollY < 0 ? s.scrollerH - s.wrapperH + s.y - s.minScrollY : 0, s.options.bounce ? s.wrapperH : 0) : R;
//                            x = s.x + Q.dist;
//                            I = s.y + R.dist;
//                            if (s.x > 0 && x > 0 || s.x < s.maxScrollX && x < s.maxScrollX)Q = {dist: 0, time: 0};
//                            if (s.y > s.minScrollY && I > s.minScrollY || s.y < s.maxScrollY && I < s.maxScrollY)R = {
//                                dist: 0,
//                                time: 0
//                            };
...
//                                }
//                            }
//                            s.scrollTo(c.round(x), c.round(I), Q)
...
//                            setTimeout(function () {
//                                s.doubleTapTimer = null;
//                                for (K = A.target; K.nodeType != 1;)K = K.parentNode;
//                                if (K.tagName != "SELECT" && K.tagName != "INPUT" && K.tagName != "TEXTAREA") {
...
//                A = u.wheelDeltaX / 2;
//                K = u.wheelDeltaY / 2
//            } else if ("wheelDelta"in u)A = K = u.wheelDelta / 2; else if ("detail"in u)A = K = -u.detail * 9; else return;
//            if (s.options.wheelAction == "zoom") {
//                K = s.scale * Math.pow(2, 1 / 3 * (K ? K / Math.abs(K) : 0));
//                if (K < s.options.zoomMin)K = s.options.zoomMin;
//                if (K > s.options.zoomMax)K = s.options.zoomMax;
//                if (K != s.scale) {
...
//                if (K > s.minScrollY)K = s.minScrollY; else if (K < s.maxScrollY)K = s.maxScrollY;
//                s.maxScrollY < 0 && s.scrollTo(A, K, 0)
//            }
//        },
...
//        },
//        _startAni: function () {
//            var u = this, s = u.x, A = u.y, K = Date.now(), L, Q, R;
...
//            A = 0;
//            for (K = this.pagesX.length; A < K; A++)if (u >= this.pagesX[A]) {
//                L = A;
//                break
//            }
//            L == this.currPageX && L > 0 && this.dirX < 0 && L--;
//            u = this.pagesX[L];
//            K = (K = c.abs(u - this.pagesX[this.currPageX])) ? c.abs(this.x - u) / K * 500 : 0;
//            this.currPageX = L;
...
//                    K = this._offset(A[u]);
//                    K.left += this.wrapperOffsetLeft;
//                    K.top += this.wrapperOffsetTop;
//                    this.pagesX[u] = K.left < this.maxScrollX ? this.maxScrollX : K.left * this.scale;
//                    this.pagesY[u] =
//                        K.top < this.maxScrollY ? this.maxScrollY : K.top * this.scale
//                }
//            } else if (this.options.snap) {
//                for (this.pagesX = []; K >= this.maxScrollX;) {
//                    this.pagesX[s] = K;
//                    K -= this.wrapperW;
//                    s++
//                }
...
//                s = K = 0;
//                for (this.pagesY = []; K >= this.maxScrollY;) {
//                    this.pagesY[s] = K;
//                    K -= this.wrapperH;
//                    s++
//                }
...
//            }
//        },
//        scrollTo: function (u, s, A, K) {
//            var L = u;
//            this.stop();
//            L.length || (L = [{x: u, y: s, time: A, relative: K}]);
//            u = 0;
...
//                var y, F, H, M;
//                return p = h.getBoundingClientRect(), y = Math.max(document.documentElement.scrollTop, document.body.scrollTop), F = Math.max(document.documentElement.scrollLeft, document.body.scrollLeft), H = document.body.clientTop, M = document.body.clientLeft, {
//                    x: p.left + F - M,
//                    y: p.top + y - H
//                }
//            }
...
//            this.setting = {
//                enableHttps: g("enableHttps", false),
//                enableCtrlEnter: g("enableCtrlEnter", false),
//                enableVoice: g("enableVoice", true),
//                enableNotification: g("enableNotification", true)
//            }
//        };
...
//                    item: this._arr[this._selectedIndex],
...
//                var e = this.elem.getBoundingClientRect().top, j = document.documentElement.clientHeight;
//                e =
//                    c.getBoundingClientRect().top - e;
//                c = c.clientHeight;
...
//            }, destory: function () {
//                this.scrollObj.options.onScrollEnd =
//                    null;
...
//    JM.$package("MUI", function (g) {
//        var a = g.dom, b = g.event, c = g.platform.touchDevice, e, j = (c = g.platform.touchDevice) ? "touchstart" : "mousedown", f = c ? "touchmove" : "mousemove", n = c ? "touchend" : "mouseup", m = "getBoundingClientRect"in document.body, r = g.Class({extend: MUI.Slide}, {
//            init: function (k) {
...
//                    id: this.id,
//                    title: m.title || f("unname"),
//                    className: m.className || "",
//                    hasHeader: typeof m.hasHeader ===
//                    "undefined" ? true : m.hasHeader,
//                    leftButton: m.leftButton || false,
//                    rightButton: m.rightButton || false,
//                    hasFooter: !!m.footer || m.hasFooter || false,
//                    footer: m.footer,
//                    body: b.extend({html: "", className: ""}, m.body || {}),
//                    encode: j.encodeHtml
//                };
...
//        var a = this, b = JM.event, c = JM.dom, e = mq.DYNAMIC_CGI_URL + "channel/login2", j = mq.DYNAMIC_CGI_URL + "channel/poll2", f = mq.STATIC_CGI_URL + "api/getvfwebqq", n = mq.DYNAMIC_CGI_URL + "channel/refuse_file2", m = mq.DYNAMIC_CGI_URL + "channel/notify_offfile2", r = {
...
//                    onSuccess: G.onSuccess && function (s) {
//                        s = s.responseText || "-";
//                        var A = {};
//                        try {
//                            A = JSON.parse(s)
...
//                A.innerHTML = '<iframe id="' + O + '" class="hiddenIframe" name="' + O + '" src="' + G + '" width="1" height="1"></iframe>';
//                s.appendChild(A);
//                s = document.getElementById(O);
//                this.id = E;
//                this.onAjaxFrameLoad = function () {
//                    var K = window.frames[O];
//                    try {
//                        if (K.ajax) {
//                            u._proxyAjaxSend = K.ajax;
//                            var L = u._ajaxCallbacks;
//                            K = 0;
//                            for (var Q = L.length; K < Q; K++)u.proxySend(L[K].url, L[K].option);
//                            u._ajaxCallbacks = []
//                        }
//                    } catch (R) {
...
//                    for (var K = u._ajaxCallbacks, L = 0, Q = K.length; L < Q; L++)u.proxySend(K[L].url, K[L].option);
//                    u._ajaxCallbacks = []
//                });
...
//                var u = RegExp.$1;
//                if ("postMessage"in window && !g.browser.ie)window.frames[G.iframeName].postMessage(O, u); else {
//                    var s = c.node("div");
...
//                if (G)E = E.replace("proxy.html",
//                    "cfproxy.html").replace("http://", "https://");
//                var O = this._proxyArr[E];
//                if (!O) {
//                    O = G ? new z(this.getProxyId(), E) : new B(this.getProxyId(), E);
//                    this._proxyArr[E] = O
//                }
//                return O
...
//            E = g.type.isObject(E) ? E : JSON.parse(E);
...
//            var G = E.data || E.param || {}, O = E.url, u = E.action, s = E.https, A;
//            if (/^(http|https):\/\/d.web2.qq.com/.test(O)) {
//                O = O.replace(/https/, "http");
//                if (A = g.cookie.get("uin")) {
//                    A = A.replace("o", "");
//                    O = O.replace(/^http:\/\/d.web2.qq.com/, "http://d1.web2.qq.com")
//                }
//            }
//            E.method = E.method || "GET";
//            E.data = E.method == "POST" ? {r: JSON.stringify(G)} : G;
//            E.onSuccess = E.onSuccess || function (L) {
//                    var Q = "retcode"in L ? L.retcode : "ret"in L ? L.ret : -1;
//                    window.MM && MM.report(O.split("?")[0],
//                        Q || 0, +new Date - K);
//                    Q === 0 ? b.fire(a, u + "Success", L) : b.fire(a, u + "Failure", L)
//                };
//            E.onError = E.onError || function (L) {
//                    b.fire(a, u + "Failure", L)
//                };
//            E.onTimeout = E.onTimeout || function (L) {
//                    b.fire(a, u + "Timeout", L)
//                };
//            d || (d = new q);
...
//            }, G = mq.util.code2state(mq.main.loginType);
//            E.status = G;
...
//            this.require({
//                url: f, action: "getVfWebQQ", method: "GET", data: {
//                    ptwebqq: mq.ptwebqq, clientid: mq.clientid,
//                    psessionid: mq.psessionid
//                }
//            })
//        };
...
//                action: "poll",
//                method: "POST",
//                data: {ptwebqq: mq.ptwebqq, clientid: mq.clientid, psessionid: mq.psessionid, key: ""},
//                timeout: 12E4,
//                onSuccess: D,
//                onError: p,
//                onTimeout: y
...
//                }
//            } else if (G === 100)b.fire(a, "NotReLogin"); else if (G === 120)b.fire(a, "ReLinkFailure", E); else if (G === 121)b.fire(a,
//                "ReLinkFailure", E); else if (G === 116) {
...
//                    b.fire(a, "PollComplete")
//                } catch (u) {
//                    mq.debug("pollComplete notify error: " + u.message, u)
//                }
//            }, 1E4)
//        }, p = function (E) {
...
//                b.fire(a, "PollComplete")
//            } catch (E) {
//                mq.debug("pollComplete notify error: " + E.message,
//                    E)
//            }
...
//            };
//            this.require({url: e, action: "relink", method: "POST", data: E, onSuccess: H, onError: M, onTimeout: P})
//        };
//        var H = function (E) {
//            switch (E.retcode) {
//                case 0:
...
//        };
//        this.sendRefuseOfflineFile = function (E) {
//            E.psessionid = mq.psessionid;
//            E.clientid = mq.clientid;
...
//                if (container = a.id("groupBodyUl-" + f))container.innerHTML = this.listTmpl({
//                    type: "list",
//                    list: j,
//                    prefix: this.id,
//                    html: b.encodeHtml
...
//            H = mq.STATIC_CGI_URL + "api/get_group_info_ext2", M = mq.DYNAMIC_CGI_URL + "channel/get_discu_info", P = mq.STATIC_CGI_URL + "api/get_friend_info2", E = mq.STATIC_CGI_URL + "api/get_friend_uin2", G = mq.DYNAMIC_CGI_URL + "channel/get_online_buddies2", O = mq.DYNAMIC_CGI_URL + "channel/change_status2", u = function (x, I) {
//                x += "";
...
//            }, A = function (x) {
//                g.each(x.dnamelist, function (I) {
//                    c.addDiscuss(new X(I))
//                });
//                a.fire(c, "discussListChange", m)
//            }, K = function (x, I, N, T, U) {
//                N = 0;
//                for (var V =
//                    x.length; N < V; N++) {
//                    var Y = x[N];
...
//                    x = x.marknames || [];
//                    for (var V = {}, Y = false, S = 0; S < I.length; S++)if (I[S].index == 0)Y = true;
//                    for (S = 0; S < x.length; S++)V[x[S].uin] = x[S];
//                    Y || I.unshift({index: 0, name: "\u6211\u7684\u597d\u53cb"});
//                    K(I, N, T, U, V)
//                }, onGetFriendUinSuccess: function (x) {
//                    var I = c.getFriendByUin(x.uin);
//                    if (I) {
//                        I.ruin = x.account;
//                        a.fire(c, "friendInfoUpdate", I)
//                    }
...
//                    a.fire(c,
//                        "recentListChange", f)
//                }, onGetSignatureSuccess: function (x, I) {
//                    c.addSignature(x, I);
//                    var N = c.getFriendByUin(x);
//                    N && N.setSignature(I);
//                    a.fire(c, "signatureGot", x, I)
//                }, onGetSelfInfoSuccess: function (x) {
//                    c.setSelfInfo(x);
//                    a.fire(c, "selfInfoChange", x)
//                }, onGetGroupInfoListSuccess: function (x) {
//                    var I = x.ginfo, N = I.members, T = x.minfo, U = x.vipinfo, V = x.cards || [], Y = V.length || 0, S = c.getGroupByGid(I.gid);
//                    g.extend(S, I);
//                    S.hasDetailInfo = true;
//                    S.members = [];
//                    g.each(N, function (ba, W) {
//                        for (var Z = "", ca = ba.muin, $ = T[W], da = U[W], aa = 0; aa < Y; aa++)if (V[aa].muin ==
//                            ca) {
//                            Z = V[aa].card;
//                            break
//                        }
...
//                    var I = x.info, N = I.mem_list, T = x.mem_info, U = c.getDiscussById(I.did);
...
//        };
//        this.getAvatar = function (x, I) {
//            I = I || 1;
//            return "http://face" + x % 10 + ".web.qq.com/cgi/svr/face/getface?cache=1&type=" +
//                I + "&f=40&uin=" + x + "&t=" + Math.floor(new Date / 1E3) + "&vfwebqq=" + mq.vfwebqq
//        };
...
//            var I = {};
//            I.vfwebqq = mq.vfwebqq;
//            I.clientid = mq.clientid;
//            I.psessionid = mq.psessionid;
//            mq.rpcService.require({
//                url: p, method: "POST", withCredentials: true, param: I, onSuccess: function (N) {
//                    if (N.retcode == 0) {
...
//                    url: y,
//                    method: "GET",
//                    param: {tuin: x, vfwebqq: mq.vfwebqq},
//                    withCredentials: true,
//                    onSuccess: function (I) {
//                        I.retcode === 0 && L.onGetSignatureSuccess(x, I.result[0].lnick)
//                    }
//                })
//            };
...
//            I.vfwebqq = mq.vfwebqq;
//            mq.rpcService.require({
//                url: H, method: "GET", param: I, withCredentials: true, onSuccess: function (N) {
...
//            I.psessionid = mq.psessionid;
//            mq.rpcService.require({
//                url: M, method: "GET", param: I, withCredentials: true, onSuccess: function (N) {
...
//            I.vfwebqq = mq.vfwebqq;
//            mq.rpcService.require({
//                url: E, method: "GET", param: I, withCredentials: true, onSuccess: function (N) {
...
//            I.psessionid = mq.psessionid;
//            mq.rpcService.require({
//                url: P, method: "GET", param: I, withCredentials: true, onSuccess: function (N) {
...
//            x.psessionid = mq.psessionid;
//            mq.rpcService.require({
//                url: G, method: "GET", param: x, withCredentials: true, onSuccess: function (I) {
//                    I.retcode === 0 && L.onGetBuddyOnlineStateSuccess(I.result)
//                }
//            })
//        };
//        this.getBuddyInfo = function (x, I) {
//            I = I || "friend";
//            var N;
//            if (I == "friend") {
...
//            return x
//        };
//        this.addSignature = function (x, I) {
//            if (!z[x]) {
//                z[x] =
//                    I;
//                r.push(I)
...
//            mq.rpcService.require({
//                url: F, method: "GET", withCredentials: true, onSuccess: function (x) {
...
//            var I = [], N = n.concat(j).concat(m);
//            x.length > 0 && g.each(N, function (T) {
//                if (T.name.toUpperCase().indexOf(x.toUpperCase()) > -1 || T.mark && T.mark.toUpperCase().indexOf(x.toUpperCase()) > -1)I.push(T)
//            });
//            return I
//        };
...
//            x.psessionid = mq.psessionid;
//            mq.rpcService.require({
//                url: O, method: "GET", param: x, withCredentials: true, onSuccess: function () {
//                    mq.rpcService.require({
//                        url: G, method: "GET", param: x, withCredentials: true, onSuccess: function () {
//                        }
//                    })
//                }
//            })
...
//                var f = b.contactView;
//                f.memberListAreas.friend.render({
//                    type: "category",
//                    list: e
//                }, true);
...
//        };
//        var C = {
//            onPollMessageSuccess: function (h) {
...
//                                sender: h,
//                                sender_uin: v,
//                                time: o.time ? o.time * 1E3 : +new Date
//                            };
//                            n.addMessage(v, D)
//                        }
//                        break;
...
//            mq.rpcService.require({
//                url: f, param: o, withCredentials: true, method: "GET", onSuccess: function (v) {
...
//            mq.rpcService.require({
//                url: c, param: h, withCredentials: true, method: "POST", onSuccess: function () {
//                }
//            })
//        };
...
//                    to_uin: D,
//                    to_user: p,
//                    time: h.time ? h.time * 1E3 : +new Date
//                };
...
//                from_uin: 0,
//                to: h.from_uin,
//                content: [["refuseofffile", "\u60a8\u62d2\u7edd\u63a5\u6536\u201c" + h.name + "\u201d\uff0c\u6587\u4ef6\u4f20\u8f93\u5931\u8d25\u3002"]],
...
//            var o = [["nextofffile", '\u60a8\u53d6\u6d88\u4e86\u79bb\u7ebf\u6587\u4ef6"' + h.name + '"\u7684\u63a5\u6536\uff0c\u6211\u4eec\u5c06\u5728\u60a8\u4e0b\u6b21\u767b\u5f55\u540e\u8fdb\u884c\u63d0\u9192\u3002']], v = {
//                type: "nextofffile",
...
//        $F = mq.i18n.faceText;
//        var m = null, r = null, k = false, d, t, B, z, q, w = {
//            group: [{text: n("group_member"), cmd: "viewMembers"}, {
//                text: n("group_profile"),
//                cmd: "viewInfo"
//            }, {text: n("record"), cmd: "viewRecord"}],
//            discuss: [{text: n("discuss_member"), cmd: "viewMembers"}, {
//                text: n("discuss_profile"),
//                cmd: "viewInfo"
//            }, {text: n("record"), cmd: "viewRecord"}],
//            friend: [{text: n("qzone"), cmd: "viewQzone"}, {text: n("profile"), cmd: "viewInfo"}, {
//                text: n("record"),
//                cmd: "viewRecord"
//            }]
//        };
...
//                    leftButton: {className: "btn_setting", text: ""},
//                    rightButton: {className: "btn_setting", text: n("close")},
//                    body: {className: "chat_container"},
//                    footer: {
...
//                        id: "chat", element: this.panel.container, callback: function () {
//                            c.scroll.refresh();
//                            d.reset();
//                            c.scroll.scrollTo(0,
...
//            128, 129, 130, 131, 132, 133, 134, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170], q = /\[([A-Z\u4e00-\u9fa5]{1,20}?)\]/gi, w = ["font", {
//            name: "\u5b8b\u4f53",
//            size: 10,
//            style: [0, 0, 0],
//            color: "000000"
//        }], C = {
//            onMessageReceived: function (p) {
...
//                    H.isStrange && f.model.sendGetSessionSignature({
//                        to_uin: p,
//                        group_uin: H.groupUin,
//                        discuss_uin: H.discussUin
//                    })
//                }
...
//                    p = JSON.stringify(d);
//                    H = {
//                        notNotify: true, content: d, from_uin: H,
//                        sender_uin: H, from_user: M, sender: M, to_uin: P, to_type: E, time: Date.now()
//                    };
//                    if (E == "friend") {
//                        F.getFriendByUin(P).isStrange ? y.sendSessMsg({
//                            to: P,
//                            content: p,
//                            face: M.face
//                        }) : y.sendMsg({to: P, content: p, face: M.face});
...
//                    id: "search",
//                    scrollArea: m,
//                    listContainer: e.id("search_result_list"),
//                    listTmpl: a
//                });
...
//                    id: "search",
//                    scrollArea: m,
//                    listContainer: e.id("member_search_result_list"),
//                    listTmpl: a
//                });
//                c.bindCommands(b.panel.container, f);
//                c.on(b.searchInput, "input", n.onSearchInput)
...
//                    title: f("record"),
//                    hasBackButton: true,
//                    body: {className: "record_container"},
//                    footer: {className: "record_toolbar_footer", html: g({$M: f})}
//                };
...
//                    parent: k,
//                    title: f("contact"),
//                    rightButton: {text: "", className: "btn_search"},
//                    leftButton: {className: "contact_null_btn"},
//                    body: {html: g({$M: f})}
//                };
//                this.panel = new mq.view.TitlePanel(k)
//            }
...
//                this.memberListAreas[q] = new mq.view.MemberList({
//                    id: q,
//                    scrollArea: w.children[0],
//                    listContainer: w.children[0].children[0],
//                    listTmpl: a
//                });
//                if (q === "friend") {
...
//                    title: j("setting"),
//                    hasScroller: true,
//                    body: {className: "list_page setting"}
//                };
//                this.panel = new mq.view.TitlePanel(m);
...
//        var g = this, a = JM.event, b = {
//            onStartDisplayPlugin: function (c) {
...
//            id: "qzone",
//            url: f ? "http://pt.3g.qq.com/s?aid=touchLogin&t=qzone&bid_code=qzoneLogin&go_url=http://m.qzone.com/infocenter" : "http://qz.qq.com/",
//            text: j("qzone")
//        }, {
//            id: "qmail",
//            url: f ? "http://w.mail.qq.com/" : "http://ptlogin2.qq.com/pt4_web_jump?pt4_token=g3jdGooid--jhmLnMc5mIA__&daid=4&appid=522005705&succ_url=http%3A%2F%2Fmail.qq.com%2Fcgi-bin%2Flogin%3Ffun%3Dpassport%26from%3Dwebqq",
//            text: j("qmail")
//        }, {
//            id: "qq_portal",
//            url: f ? "http://shipei.qq.com/" : "http://www.qq.com/",
//            text: j("qq_portal")
//        }], m = {
//            clickItem: function (r, k, d) {
...
//                    title: j("plugin"),
//                    hasScroller: true,
//                    body: {className: "plugin", html: g({items: n})}
//                };
//                this.panel = new mq.view.TitlePanel(r)
//            }
//            return this.panel
...
//                }
//                $TM.push({
//                    id: "displayPlugin", element: this.panel.container, callback: function () {
//                        a.scroll.refresh()
//                    }
//                })
//            }
...
//        this.createPanel = function () {
//            if (!this.panel) {
//                this.panel = new e.TitlePanel({
//                    parent: e.main.container,
//                    className: "plugin-displayer-panel",
//                    leftButton: {className: "btn_arrow_left", text: j("return")},
//                    body: {
...
//        function a(q, w) {
//            var C;
//            if (f.Notification)C = new f.Notification(q, {
//                icon: j.isString(w.icon) ? w.icon : d,
//                body: w.body || d,
//                tag: w.tag || undefined
...
//        var a = this, b = g.event, c = mq.view.desktopNotificationManager, e = window, j = e.document, f = mq.presenter.chat.translateMessage2Text, n = [], m = {
//            onClose: function (r) {
...
//            onAllMessageReceived: function (e) {
//                var j = e.from_group || e.from_user || e.from_discuss;
//                j = a.buddylistModel.getBuddyInfo(j.account, j.type);
//                var f = e.notNotify;
//                a.desktopView.onAllMessageReceived({
//                    content: e.content,
//                    avatar: j.avatar,
//                    name: j.name
//                }, !mq.setting.enableNotification || f);
...
//                    parent: mq.view.main.container,
//                    className: "profile-panel",
//                    title: j("notify_setting"),
//                    body: {className: "list_page notify_setting"},
//                    hasBackButton: true,
//                    hasScroller: true
//                };
//                this.panel = new mq.view.TitlePanel(k);
...
//            mq.view.transitionManager.push({
//                id: "notifySetting", element: this.panel.container, callback: function () {
//                    d.scroller.refresh()
//                }
//            })
//        }
...
//        };
//        var b = {
//            onViewNotifySetting: function (c) {
//                c || (c = {});
...
//                className: "plugin",
//                text: r("plugin")
//            }, {id: "setting", className: "setup", text: r("setting")}], C = g({items: w});
//            q.footer = {html: C};
...
//                document.body.appendChild(e)
//            }
//            e.firstChild.src = "https://ui.ptlogin2.qq.com/cgi-bin/login?" + c.serializeParam({
//                    daid: 164,
//                    target: "self",
//                    style: 16,
//                    mibao_css: "m_webqq",
...
//                    }, 1E3);
//                    b.fire(f, "SelfOffline", {
//                        message: "\u56e0\u7f51\u7edc\u6216\u5176\u4ed6\u539f\u56e0\u4e0e\u670d\u52a1\u5668\u5931\u53bb\u8054\u7cfb\uff0c\u6b63\u5728\u5c1d\u8bd5\u91cd\u65b0\u767b\u5f55...",
//                        action: "relink"
//                    })
//                } else z.onReLinkStop();
//                k++
